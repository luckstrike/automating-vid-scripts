<script lang="ts">
	...
	function toggleSortByName() {
		filteredData.sort((a, b) =>
			isNameAscending ? a.name.localeCompare(b.name) : b.name.localeCompare(a.name)
		);
...
<div class="flex flex-col items-center">
	{#if !isLoading}
		...
		<p class="text-lg text-white">or create a new script with Brainstorm or Summarize a URL!</p>
